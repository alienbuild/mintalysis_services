...
BASE_URL = 'https://api.x.immutable.com/v1/deposits'
...
try:
    with mysql.connector.connect(**db_config) as conn:
        with conn.cursor() as cursor:
            ...
            insert_query = """
            INSERT IGNORE INTO imx_deposits
            (txn_id, status, wallet_id, token_type, token_id, id, token_address, decimals, quantity, quantity_with_fees, timestamp, timestamp_d, updatedAt)
            ...
            while True:
                ...
                if result: 
                    ...
                    for record in result:
                        ...
                        batch_data.append((transaction_id, status, wallet_id, token_type, token_id, id_value, token_address, decimals, quantity, quantity_with_fees, timestamp_str, timestamp_d, updatedAt))
